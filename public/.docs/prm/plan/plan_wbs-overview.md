...
> **Status:** M0–M11 **Done** (plus the pre-M12 NASA quality gate); M12 in progress (12.1–12.2 done). Checkboxes are checked off in each plan doc as checkpoints land; live status is tracked in [Direct & Manage Project Work](../execute/execute_work_management.md).
