...
> **Status:** all checkpoints are **Not started** (tracking reset 2026-09-14 when the plan moved from the old 4-milestone WBS to this M0–M15 system). Live status is tracked in [Direct & Manage Project Work](../execute/execute_work_management.md).
