...
// The per-beat durations live in logic/beat-durations.ts (150-LOC file
// rule); re-exported so `choreography` stays the single import point.
export { beatDurations, BEAT_BUDGET_MS, REST_MS, type BeatDurations } from './logic/beat-durations'
